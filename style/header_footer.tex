% Header and Footer
\pagestyle{fancy}
\lhead{\tikz[baseline=(X.base)] \node[fill=cyan!80!blue, text=white, font=\bfseries, rounded corners=5pt, inner sep=5pt] (X) {FIT-HCMUS};}
\rhead{\textbf{University of Science - VNUHCM}}
\lfoot{\textbf{[Tên môn học]}}
\cfoot{}
